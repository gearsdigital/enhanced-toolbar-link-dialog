...
},{}],"components/BetterLinkDialog.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    kirbytext: function kirbytext() {
      return this.$store.state.system.info.kirbytext;
    }
  },
  methods: {
    open: function open(input, selection) {
    ...
    selectPage: function selectPage(model) {
      this.value = {
        url: model.url,
    ...
    createKirbytext: function createKirbytext() {
      if (this.value.text.length > 0) {
        return "(link: ".concat(this.value.url, " text: ").concat(this.value.text, ")");
      } else {
        return "(link: ".concat(this.value.url, ")");
      }
    },
    createMarkdown: function createMarkdown() {
      if (this.value.text.length > 0) {
        return "[".concat(this.value.text, "](").concat(this.value.url, ")");
      } else {
        return "<".concat(this.value.url, ">");
      }
    },
    fetch: function fetch() {
      ...
      this.$api.get('better-link/pages', params).then(function (response) {
...
function debounce(fn) {
  ...
  return function () {
    ...
    timer = setTimeout(function () {
      fn.apply(context, args);
        ...
        var $27108d = exports.default || module.exports;
      
      if (typeof $27108d === 'function') {
        $27108d = $27108d.options;
      }
    
        /* template */
        Object.assign($27108d, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "k-dialog",
    {
      ...
      attrs: { size: "medium", button: _vm.$t("insert") },
      on: { submit: _vm.submit, open: _vm.fetch, close: _vm.resetForm }
    },
    [
      _vm.tabs && _vm.tabs.length > 1
        ? _c("div", { staticClass: "k-header-tabs" }, [
            _c(
              "nav",
                ...
                return _c(
                  "k-button",
                  {
                    ...
                    attrs: {
                      link: "#" + tab.name,
                      current:
                        _vm.currentTab && _vm.currentTab.name === tab.name
                    },
                    on: {
                ...
                _vm._b(
                  {
                    ...
                    attrs: { details: true, dropdown: false, align: "center" },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$27108d', $27108d);
          } else {
            api.reload('$27108d', $27108d);
          }
        }
...
var _BetterLinkDialog = _interopRequireDefault(require("./components/BetterLinkDialog"));
...
panel.plugin('gearsdigital/kirby-better-link', {
  components: {
    'k-toolbar-link-dialog': {
      extends: _BetterLinkDialog.default
    }
  }
});
},{"./components/BetterLinkDialog":"components/BetterLinkDialog.vue"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
